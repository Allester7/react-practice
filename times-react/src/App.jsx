      ...
      <div className="timer">
        ...
        {showClock ?
          timeArray.map((time,index) => {
            ...
            return <Time key={index} time={time} handleClock={handleclock} index={index} inputRef={inputRefs[index]} // Pass the current ref
        ...
        <button type="button" className="btn start" onClick={handleStart}>Start</button>
